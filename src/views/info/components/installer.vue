    ...
    >
      ...
      <el-form label-position="top" :model="form">
        <div class="flex gap-6 md:flex-col">
            <el-form-item class="flex-1" label="Company">
                <el-input v-model="form.name" placeholder="Company" />
            </el-form-item>
            <el-form-item class="flex-1" label="Address">
                <el-input v-model="form.name" placeholder="Address" />
            </el-form-item>
        </div>
        <div class="flex gap-6 md:flex-col">
        ...
        <div class="flex gap-6 md:flex-col mb-6">
            <div class="!flex-1">
                ...
                <el-form-item class="flex-1 mb-0" label="Telephone">
                    <el-input v-model="form.name" placeholder="Company" />
                </el-form-item>
            </div>
            <div class="!flex-1 overflow-auto border border-gray-200 rounded-md !box-border">
                <div class="flex w-full p-3 h-full">
                    ...
                    <div class="w-[120px] text-xs flex box-border justify-center items-center h-full border border-gray-200 rounded-md">
                        QR code 
                    </div>
                </div>
            </div>
